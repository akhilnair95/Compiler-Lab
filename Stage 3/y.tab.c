...
{
  "$end", "error", "$undefined", "READ", "WRITE", "ASG", "END", "ID",
  "PLUS", "MUL", "NUM", "';'", "'('", "')'", "$accept", "Program", "slist",
...
{
      20,   -10,    -7,    -2,     8,    15,   -11,     4,    -6,    -6,
     -11,   -11,   -11,    16,   -11,   -11,    -6,     1,    17,     6,
       7,    -6,    -6,    19,   -11,   -11,   -11,    22,   -11,   -11
};
...
{
       0,     0,     0,     0,     0,     0,     4,     0,     0,     0,
       1,     2,     3,     0,    12,    11,     0,     0,     0,     0,
       0,     0,     0,     0,     5,     6,    10,     8,     9,     7
};
...
{
      18,    14,     7,     9,    15,     8,    16,    20,    10,    21,
      22,    13,    27,    28,    23,    21,    22,    25,     1,     2,
      26,    11,     3,     1,     2,    21,    22,     3,    24,    19,
      29,    22,    12
};

static const yytype_uint8 yycheck[] =
{
       9,     7,    12,     5,    10,    12,    12,    16,     0,     8,
       9,     7,    21,    22,    13,     8,     9,    11,     3,     4,
      13,     6,     7,     3,     4,     8,     9,     7,    11,    13,
      11,     9,     5
};
...
{
       0,     3,     4,     7,    15,    16,    17,    12,    12,     5,
       0,     6,    17,     7,     7,    10,    12,    18,    18,    13,
      18,     8,     9,    13,    11,    11,    13,    18,    18,    11
};
...
#line 29 "expl.y" /* yacc.c:1646  */
    { 
						 var[(yyvsp[-3].integer) - 'a'] = (yyvsp[-1].integer);
						}
...
#line 41 "expl.y" /* yacc.c:1646  */
    {
					(yyval.integer) = var[(yyvsp[0].integer) - 'a'];
			}
